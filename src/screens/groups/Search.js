...
import {View, FlatList, ActivityIndicator, StyleSheet, TouchableOpacity, Text, TouchableHighlight} from "react-native";
                    ...
                    renderItem = {({item}) => (
                        <ListItem
                            ...
                            rightIcon = {<Icon
                                ...
                                color = '#559535'
                                size = {30}
                                name = {item.val().toFollow === 'true' ? 'plus-circle' : 'minus-circle'}
                                type = 'font-awesome'
                                onPress = {() => {
                                    ...
                                    /*if (item.val().toFollow === 'true') {
                                        ...
                                        updateToFollowRef.update(
                                            {
                                                toFollow: 'false',
                                            }
                                        )
                                    } else {
                                        followRef.child(key).remove(
                                            {
                                                name: item.val().FullName,
                                                email: item.val().Email,
                                            }

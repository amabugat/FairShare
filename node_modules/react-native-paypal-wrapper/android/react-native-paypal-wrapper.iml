...
<module external.linked.project.id=":react-native-paypal-wrapper" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":react-native-paypal-wrapper" />
      </configuration>
    </facet>
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: com.paypal.sdk:paypal-android-sdk-2.15.1" level="project" />
    ...
    <orderEntry type="library" name="Gradle: io.card:android-sdk-5.4.2" level="project" />
